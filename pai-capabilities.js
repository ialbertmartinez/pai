...
function closeQuote(){qModal.classList.remove('pai-open');document.body.style.overflow=''}
  ...
  if(!qModal.classList.contains('pai-open')) document.body.style.overflow='';
  window.addEventListener('pageshow',function(){ if(!qModal.classList.contains('pai-open')) document.body.style.overflow=''; });
